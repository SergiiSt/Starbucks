...
Header – логотип + навигация (Home, Select, Shop).

Hero – заголовок, подзаголовок, кнопки, справа стакан с бейджем 45%.

Stats – 9k+ Users / 2k+ Customers / 28+ Awards.

Features – 3 карточки (Tasty, Fast, Available).

About / Delicious – слева фото кафе, справа текст + кнопка “Cooking Process”.

Products – карусель напитков с карточками.

Events – сетка из карточек (2x3) с кнопкой “More”.

Contacts – соцсети, телефон, фото.

Footer – навигация, копирайт, контакты.
